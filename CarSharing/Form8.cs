    ...
    public partial class Form8 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if(button2.Text == "Заблокировать пользователя")
            {
                ...
                {
                    MessageBox.Show("Пожалуйста, отправьте пользователю сообщение, чтобы он мог знать причину блокировки", "Внимание", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
